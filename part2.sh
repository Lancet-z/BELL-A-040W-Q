...
# 修改默认wifi名称ssid为迷宫旅人
#sed -i 's/ssid=OpenWrt/ssid=迷宫旅人/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh

#开启MU-MIMO
#sed -i 's/mu_beamformer=0/mu_beamformer=1/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh

#wifi加密方式，没有是none，改为psk2
#sed -i 's/encryption=none/encryption=psk2/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh

#wifi密码
#sed -i 's/key=1234567890/key=gds.2021/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
